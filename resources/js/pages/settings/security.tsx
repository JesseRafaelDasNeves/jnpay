                    ...
                    {twoFactorEnabled ? (
                        <div className="flex flex-col items-start justify-start space-y-4">
                            <p className="text-sm text-muted-foreground">
                                ...
                                durante o login, que você pode recuperar do
                        ...
                        <div className="flex flex-col items-start justify-start space-y-4">
                            <p className="text-sm text-muted-foreground">
                                Quando você ativa a autenticação de dois fatores, você
                                será solicitado a fornecer um PIN seguro durante o login.
                                Este PIN pode ser recuperado de um aplicativo
                                compatível com TOTP em seu telefone.
                            </p>
